...
$where_clause = "WHERE v.voucher_type = 'Sales'";
...
<html>
<head>
    <title>Sales Vouchers - FINPACK</title>
    ...
    <div class="main-container">
        <div class="header-section">
            <div class="header-title">
                <h2><i class="fas fa-cash-register"></i> Sales Vouchers</h2>
                <p class="record-count"><?= number_format($total_rows) ?> records found</p>
            </div>
            <div class="action-buttons">
                <a href="sales_voucher.php" class="btn btn-primary">
            ...
            <form method="get" class="filter-form">
                <div class="filter-group">
                    ...
                    <?php if (!empty($date_filter)): ?>
                        <a href="sales_list.php" class="btn btn-clear">
                    ...
                    <?php if (empty($vouchers)): ?>
                        <tr>
                            <td colspan="6" class="no-data">
                                <i class="fas fa-database"></i> No sales vouchers found
                            </td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <a href="view_sales.php?id=<?= $voucher['voucher_id'] ?>" class="action-btn view-btn" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="edit_sales.php?id=<?= $voucher['voucher_id'] ?>" class="action-btn edit-btn" title="Edit">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <a href="delete_sales.php?id=<?= $voucher['voucher_id'] ?>" 
