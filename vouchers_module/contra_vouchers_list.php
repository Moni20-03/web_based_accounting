    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($voucher['from_ledger']) ?></td>
                <td><?= number_format($voucher['total_amount'], 2) ?></td>
                <td>
                    <a href="edit_contra.php?id=<?= $voucher['voucher_id'] ?>" class="btn btn-primary">
