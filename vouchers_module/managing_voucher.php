...
<body>
    ...
    <div class="main-container">
        <div class="voucher-menu-box">
            ...
            <p>Select the type of voucher you want to manage:</p>
            
            <div class="voucher-options">
                <div class="voucher-option" onclick="location.href='payment_vouchers_list.php'">
                    <i class="fas fa-money-bill-wave"></i>
                    <h3>Payment Voucher</h3>
                    <p>Record outgoing payments</p>
                </div>
                
                <div class="voucher-option" onclick="location.href='receipt_vouchers_list.php'">
                    <i class="fas fa-receipt"></i>
                    <h3>Receipt Voucher</h3>
                    <p>Record incoming payments</p>
                </div>
                
                <div class="voucher-option" onclick="location.href='journal_vouchers_list.php'">
                    <i class="fas fa-book"></i>
                    <h3>Journal Voucher</h3>
                    <p>Record non-cash transactions</p>
                </div>
                
                <div class="voucher-option" onclick="location.href='contra_vouchers_list.php'">
                    <i class="fas fa-exchange-alt"></i>
                    <h3>Contra Voucher</h3>
                    <p>Record cash transfers</p>
                </div>

                <div class="voucher-option" onclick="location.href='sales_vouchers_list.php'">
                    <i class="fas fa-cash-register"></i>
                    <h3>Sales Voucher</h3>
                    <p>Record sales transactions</p>
                </div>
            
                <div class="voucher-option" onclick="location.href='purchase_vouchers_list.php'">
