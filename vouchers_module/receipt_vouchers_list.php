...
$where_clause = "WHERE v.voucher_type = 'Receipt'";
    ...
    <div class="main-container">
        <div class="header-section">
            <div class="header-title">
                <h2><i class="fas fa-receipt"></i> Receipt Vouchers</h2>
            ...
            <form method="get" class="filter-form">
                <div class="filter-group">
                    ...
                    <?php if (!empty($date_filter)): ?>
                        <a href="receipt_list.php" class="btn btn-clear">
                    ...
                    <?php if (empty($vouchers)): ?>
                        <tr>
                            <td colspan="5" class="no-data">
                                <i class="fas fa-database"></i> No receipt vouchers found
                            </td>
                        </tr>
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td data-label="Action" class="actions">
                                ...
                                <a href="delete_receipt.php?id=<?= $voucher['voucher_id'] ?>" 
